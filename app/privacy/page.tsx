      ...
      <div className="prose max-w-none space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Basic details: name, email, profession, role/industry, and booking details (via Topmate).</li>
            <li>Intake responses: aspirations, learning goals, challenges, expected impact.</li>
            <li>Session data: notes, materials, or assignments you voluntarily share.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Deliver and personalize mentorship, workshops, and resources.</li>
            <li>Create tailored learning roadmaps (IMPACT/ADAPT frameworks).</li>
            <li>Track progress and measure impact (confidence, work outcomes, skills growth).</li>
            <li>Communicate with you about bookings, updates, and relevant resources.</li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Everything shared in 1:1 mentorship sessions, intake forms, or reflections is treated as personal and confidential.</li>
            <li>Any notes or summaries created for your learning journey are stored securely and not shared without your permission.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Payments and bookings are handled via Topmate. Please review Topmate's privacy policy for how they process your data.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Ask us to correct or delete your data (unless we must keep it for legal reasons).</li>
