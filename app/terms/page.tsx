      ...
      <div className="prose max-w-none space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Digital resources (notes, slides, templates, recordings, where applicable)</li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>All bookings and payments are handled securely via Topmate.</li>
            <li>Payment is collected upfront at the time of booking.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>You may reschedule or cancel a session with at least 48 hours' notice.</li>
            <li>Cancellations or reschedules within 48 hours of the session may not be eligible for a refund.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Services are for educational and professional development purposes only.</li>
            <li>They do not constitute financial, legal, medical, or other regulated advice.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Any materials shared (notes, slides, recordings) are for personal use only.</li>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Basic personal information (e.g., name, email, profession) is collected only to deliver services.</li>
            <li>Data you share in sessions or intake forms may be stored securely (e.g., in Google Sheets) for mentoring and progress tracking.</li>
