      ...
      <div ref={ref} className={`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in ${isVisible ? 'visible' : ''}`}>
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            <span className="px-4 py-2 bg-brand-primary/10 text-brand-primary text-xs font-semibold rounded-full border border-brand-primary/40">IBM Certified Design Thinking Practitioner</span>
            <span className="px-4 py-2 bg-brand-primary/10 text-brand-primary text-xs font-semibold rounded-full border border-brand-primary/40">Agile Certified Coach</span>
            <span className="px-4 py-2 bg-brand-primary/10 text-brand-primary text-xs font-semibold rounded-full border border-brand-primary/40">Google Certified Teacher</span>
            <span className="px-4 py-2 bg-brand-primary/10 text-brand-primary text-xs font-semibold rounded-full border border-brand-primary/40">IBM Recognised Educator</span>
          </div>
        </div>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base text-slate-800 mb-6 leading-relaxed">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white px-6 py-3 rounded-lg transition-all duration-150 font-semibold shadow-md"
          >
          ...
          <div className="mt-10 pt-8 border-t border-slate-200">
            <p className="text-sm text-slate-700 font-bold mb-4">Experience across leading organizations:</p>
            <div className="flex flex-wrap justify-center items-center gap-2 md:gap-3">
              {[
                ...
                { name: 'Telstra', color: 'bg-orange-800' },
              ...
              <span className="text-xs text-slate-600 font-bold">+8 more</span>
            </div>
          </div>
        </div>
      </div>
