...
const programSlugs = ["clarity-call", "starter-30-day", "growth-90-day"]
            ...
            <div key={program.id} className="relative p-6 bg-white rounded-2xl border-2 border-brand-primary/20 shadow-sm flex flex-col hover:border-brand-primary hover:shadow-xl hover:shadow-brand-primary/10 hover:-translate-y-1 hover:scale-[1.02] transition-all duration-200 h-full">
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="bg-gradient-to-r from-brand-primary to-sky-500 hover:from-sky-600 hover:to-brand-primary text-white py-2.5 px-4 rounded-lg text-sm font-semibold transition-all duration-150"
                >
                  {program.cta}
                </button>
                <Link
