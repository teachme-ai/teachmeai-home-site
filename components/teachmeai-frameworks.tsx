  ...
  return (
    <section className="py-20 bg-brand-light">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-brand-dark mb-8 text-center">TeachMeAI Frameworks</h2>
        
        {/* Brand Values */}
        <div className="mb-12">
          <h3 className="text-xl font-semibold text-brand-dark mb-4">Brand Values</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {brandValues.map((value, idx) => (
              <div key={idx} className="bg-white border border-brand-border rounded-lg p-4 text-center hover:border-brand-primary transition-all duration-150">
        ...
        {/* IMPACT & ADAPT */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-brand-dark mb-4">IMPACT for adoption, ADAPT for capability</h3>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                {impact.map((item, idx) => (
                  <div key={idx} className="bg-white border border-brand-border rounded-full px-4 py-2 flex items-center gap-3">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white border border-brand-border rounded-lg p-5">
            <h4 className="font-semibold text-brand-dark mb-2">Why IMPACT Works</h4>
          ...
          <div className="bg-white border border-brand-border rounded-lg p-5">
            <h4 className="font-semibold text-brand-dark mb-2">Why ADAPT Works</h4>
